      ...
      <div className="container mx-auto px-5 lg:px-20 xl:px-32 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6 lg:gap-8">
          {areas.map((item, index) => (
            <div
              key={index}
              className={`group relative bg-luxury-goldLight/75 rounded-[20px] p-6 md:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)] hover:shadow-[0_10px_40px_rgba(212,175,55,0.12)] transition-all duration-500 hover:-translate-y-2 border border-transparent hover:border-luxury-gold/20 flex flex-col h-full mt-6 md:mt-0 ${
